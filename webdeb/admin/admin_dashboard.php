        ...
        <div class="mytabs">
            ...
            <div class="tab">
                ...
                <table>
                    ...
                    echo '<tr style="padding-bottom: 20px">
                            ...
                            <td style="padding-top: 10px;" id="email">'.$row['doctorEmail'].'</td>
                            <td style="padding-top: 10px;" id="password">'.$row['doctorPassword'].'</td>
                            <td style="padding-top: 10px;"> Dr. '.$row['doctorFirstName'].' '.$row['doctorLastName'].'</td>
                            <td style="padding-top: 10px;" id="specialization">'.$row['doctorSpecialization'].'</td>
            ...
            <table>
                    ...
                    echo '<tr>
                            ...
                            <td><input onclick="selectedButtonRemoveSched(this)" id="cancel" type="button" value="Remove" name = "Cancel" class="cancelbtn" style="background-color: red; border-color: transparent; color: white; border-radius: 5px; padding:5px;" data-bs-toggle="modal" data-bs-target="#removeschedmodal"></td>
                        </tr>';
                    }
                    ?>
                    </form>
