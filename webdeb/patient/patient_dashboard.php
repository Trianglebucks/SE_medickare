...
<html>
    ...
    <body>
            ...
            <div class="tab">
                <table>
                    ...
                    echo '<tr>
                            ...
                            <td><input id="cancel" type="button" value="Cancel" name = "Cancel" class="cancelbtn" style="background-color: rgb(255, 70, 70); border-color: transparent; color: white; border-radius: 5px; padding:5px;" data-bs-toggle="modal" data-bs-target="#exampleModal"></td>
                        </tr>';
                    }
                    ?>
                    </form>
        ...
        <script>
            ...
            function cancel() {
                var appointID = {'appointmentID': id};
