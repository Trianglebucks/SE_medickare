            ...
            <div class="tab">
                <table>
                    ...
                    echo '<tr>
                            ...
                            <td><input onclick="selectedButtonComplete(this)" id="cancel" type="button" value="Complete" name = "Cancel" class="cancelbtn" style="background-color: green; border-color: transparent; color: white; border-radius: 5px; padding:5px;" data-bs-toggle="modal" data-bs-target="#completemodal"></td>
                        </tr>';
                    }
                    ?>
                    </form>
            ...
            <div class="modal-dialog">
                ...
                <form method="POST">
                    <div class="modal-body">
                        ...
                        Start Time<br>
                        <input type="text" id="schedstarttime"><br><br>
                        End Time<br>
                        <input type="text" id="schedendtime"><br><br>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="background-color: gray; border-color: transparent; color: white; border-radius: 5px; padding:10px;">Close</button>
